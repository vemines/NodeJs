...
router.patch('/update-product/:productId', authenticationUser, authenticationShop,
    asyncHandler(ProductController.handleUpdateProductByShop)
)
router.post('/publish-product/:productId', authenticationUser, authenticationShop,
    asyncHandler(ProductController.handlePublishProductByShop)
)
router.post('/unPublish-product/:productId', authenticationUser, authenticationShop,
    asyncHandler(ProductController.handleUnPublishProductByShop)
)
router.get('/drafts/all', authenticationUser, authenticationShop,
    asyncHandler(ProductController.handleGetAllDraftsByShop)
)
router.get('/published/all', authenticationUser, authenticationShop,
